...
<html lang="en">
   <head>
      ...
      <!-- site metas -->
      <title>@yield('title','sungla')</title>
                        ...
                        <div class="collapse navbar-collapse" id="navbarsExample04" method="post">
                           <ul class="navbar-nav mr-auto">
                              ...
                              <li class="nav-item d_none sea_icon">
                                 <a class="nav-link" href="/cart"><i class="fa fa-shopping-bag" aria-hidden="true"></i><i class="fa fa-search" aria-hidden="true"></i></a>
                              </li>
                           </ul>
                        </div>
                     </nav>
 ...
 <!-- end footer -->
 <!-- Javascript files-->
 <script src="{{ asset('shop-Components/js/jquery.min.js') }}"></script>
 <script src="{{ asset('shop-Components/js/popper.min.js') }}"></script>
 <script src="{{ asset('shop-Components/js/bootstrap.bundle.min.js') }}"></script>
 <script src="{{ asset('shop-Components/js/jquery-3.0.0.min.js') }}"></script>
 <!-- sidebar -->
 <script src="{{ asset('shop-Components/js/jquery.mCustomScrollbar.concat.min.js') }}"></script>
 <script src="{{ asset('shop-Components/js/custom.js') }}"></script>
 <script>
    ...
    var image = '{{ asset('shop-Components/images/maps-and-flags.png') }}';
